...
@section('konten')
    <div class="d-flex justify-content-between align-items-center container-fluid mt-3">
        ...
        <div class="pricing-header ">
            <h1 class="display-4 font-weight-bold">PENDAFTARAN A</h1>
        </div>
        <img src="/img/bpjs.png" width="280px" height="50px" alt="" srcset="">
    </div>
    <hr>
    <div class="card-deck mb-3" id="pendaftaran2">
    ...
    <script>
        ...
        function getData() {
            $.get("{{ url('viewpendaftaranA') }}", {}, function(data, status) {
                $("#pendaftaran2").html(data);
                getData()
            })
